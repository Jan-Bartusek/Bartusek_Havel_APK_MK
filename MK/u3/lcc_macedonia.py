...
# Optimal LCC projection - Macedonia
R = 1

# Cartographic pole
uk = 43.63683487*pi/180
vk = 21.41386999*pi/180

# Outer boundary parallel
u_s = 40.85806274*pi/180
v_s = 20.99133873*pi/180

# Inner boundary parallel
u_j = 42.26021576*pi/180
v_j = 21.47698593*pi/180
...
ax.set_title('North Macedonia - Lambert (conformal conic)', fontsize=10)
plt.tight_layout()
plt.show()
